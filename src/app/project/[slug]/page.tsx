...
export default function Project() {
    ...
    return ( 
        <div className="flex flex-col items-start gap-8 w-full px-10 lg:px-32 pt-10">
            ...
            <header id="overview" className="flex flex-col lg:flex-row lg:justify-between gap-4 lg:gap-0 w-full">
            ...
            <section id="tech-stack" className="flex flex-col gap-4">
                ...
                <ul className="flex flex-row flex-wrap gap-2">
                    {project.techStack.map((tech, index) => (
                        <li key={index} className="rounded-lg bg-neutral-800 text-xs lg:text-sm font-medium p-2 border border-neutral-500">
                            {tech}
                        </li>
                    ))}
                </ul>
            ...
            <section id="key-features" className="flex flex-col gap-4">
                ...
                <ul className="bg-neutral-900 text-neutral-200 border border-neutral-800 rounded-xl w-full max-w-2xl">
                    {project.keyFeatures.map((keyFeature, index) => {
                        ...
                        return (
                            <li key={index} className="border-b border-neutral-800 last:border-none overflow-hidden px-4">
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="text-sm lg:text-md font-medium">{keyFeature.feature}</span>
                                    </div>
                                </button>
